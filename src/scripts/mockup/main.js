// @ts-nocheck
/* =========================================================================
   VENDORED from waterstrip/assets/js/main.js — keep verbatim.
   Deviations from the mockup (the only edits allowed in this file):
   0. `// @ts-nocheck` on line 1: plain vendored ES5, not ours to type.
   1. §15 FORMS removed. It preventDefault()ed #loginForm / #contactForm /
      #interestForm and faked success; the port submits those for real.
   GSAP, ScrollTrigger and Lenis are self-hosted and put on window by
   ./vendor.ts, which must be imported before this file.
   The window.WSTRIP_* data files are never shipped: the server renders that
   content, so the modules guarded by them stay inert.
   ========================================================================= */
/* =========================================================================
...
(function () {
  ...
  /* ---- 15. FORMS — removed in the Astro port: see header. ---- */
})();
