/** Edits `media_banner` — the media page's own closing membership banner. */
import type { MediaBanner } from '../../../lib/content/schemas/media-banner.ts';
...
export default function MediaBannerEditor({
  initial,
  media,
}: {
  initial: MediaBanner;
