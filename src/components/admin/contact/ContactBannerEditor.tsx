/** Edits `contact_banner` — the contact page's own closing membership banner. */
import type { ContactBanner } from '../../../lib/content/schemas/contact-banner.ts';
...
export default function ContactBannerEditor({
  initial,
  media,
}: {
  initial: ContactBanner;
