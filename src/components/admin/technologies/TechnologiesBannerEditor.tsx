/** Edits `technologies_banner` — the working-group detail page's closing membership banner. */
import type { TechnologiesBanner } from '../../../lib/content/schemas/technologies-banner.ts';
...
export default function TechnologiesBannerEditor({
  initial,
  media,
}: {
  initial: TechnologiesBanner;
  ...
  return (
    <SectionForm
      title={title}
      lede="يظهر في نهاية كل صفحة تفصيلية لمجموعة عمل."
      dirty={dirty}
      status={status}
      message={message}
      onSave={save}
